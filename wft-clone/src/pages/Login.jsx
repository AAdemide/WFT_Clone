...
export default function Login() {
    ...
    return (
        <div className="overflow-auto w-screen h-screen loginBackground dark:loginBackgroundDark bgSmall flex flex-col justify-between">
            ...
            <main className={`m-auto w-11/12 rounded-md w-[550px] bg-white dark:bg-[#201d1d] shadow-2xl shadow-gray-900/80 formHouse ${(err ? "h-[750px]" : "h-[650px]")}`}>
                ...
                <form className="relative top-36 block m-auto w-[470px] width" action="">
                    <fieldset className="flex flex-col w-[470px] width mb-4">
                        ...
                        <input className="inputHover rounded h-9 border border-[rgb(132,204,22)] inputHover bg-white dark:bg-[#201d1d] ps-3" type="text" name="" id="" placeholder="Enter Your User ID"/>
                    </fieldset>
                    <fieldset className="flex flex-col w-[470px] width">
                        <label className="mb-2" htmlFor="password">Password</label>
                        <input className="inputHover rounded h-9 border border-[rgb(132,204,22)] inputHover bg-white dark:bg-[#201d1d] ps-3" type="password" name="" id="" placeholder="Enter Your Password"/>
                    </fieldset>
